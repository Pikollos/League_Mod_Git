...
@Mod(net.slime.leaguemod.LeagueMod.MOD_ID)
public class LeagueMod {
    public static final String MOD_ID = "leaguemod";
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if(event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS) { // Verifique se é a aba de comida
            ...
            event.accept(ModItem.BALDEDIAMANTE); // Adiciona o Baldeouro
        }
